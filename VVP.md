...
the TwilioServlet File found in the directory of the cloned repository (albacol/src/main/java/net/tutorial/Servlet/TwilioServlet.java) in the line “params.put(“From”, “insert your twilio number here”)”. Ideally, this is not changed because the COMELEC already programmed its number here. Also, this will not be accessible to the public.
